...
class OperatorsNumbersAllMol:
    TEXT_PLATINUM_NUMBERS = (By.XPATH, "//h1[contains(text(), 'Платиновый номер телефона')]")
    ...
    TEXT_2_NUMBERS = (By.XPATH, "//h1[contains(text(), 'Номер телефона из двух цифр')]")
